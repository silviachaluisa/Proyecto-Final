...
const Login = () => {
    ...
    return (
        <>
            <div className="w-1/2 h-screen bg-[url('/public/images/doglogin.jpg')] bg-no-repeat bg-cover bg-center sm:block hidden"></div>
                ...
                <div className="md:w-4/5 sm:w-full">
                    ...
                    <form onSubmit={handleSubmit}>
                        ...
                        <div className="mb-3 relative">
                            ...
                            >
                                {showPassword ? (
                                    <img src="https://cdn-icons-png.flaticon.com/512/6405/6405909.png" alt="Hide" className="w-5 h-5" />
                                ) : (
                                    <img src="https://cdn-icons-png.flaticon.com/512/6803/6803345.png" alt="Show" className="w-5 h-5" />
                                )}
                            </button>
                        </div>
                        <div className="my-4">
